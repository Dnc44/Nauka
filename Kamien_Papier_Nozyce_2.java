...
public class Kamien_Papier_Nozyce_2 
{
//Gra na przewagi polega na zdobyciu o 2 więcej punktów niż przeciwnik ale warunek osiągnięcia 3 wygranych również musi być spełniony

	public static void main(String[] args) 
	{
		System.out.println("=========================================");
		System.out.println("Witaj w grze \"Kamien, papier, nozyce\" Wersja 2.0");
		System.out.println("=========================================");
		System.out.println("                                          ");
		System.out.println("Gra trwa do trzech zwyciestw na przewagi"); 
		...
		while (((resultUser < 3) && (resultComputer < 3)) || ((resultDifference < 2) && (resultDifference > -2)))
		{
		...
		int choiseUser = input.nextInt();
			...
			else if (choiseUser == 3)
			{
				...
				System.out.println("=========================================");
					...
					resultDifference = resultUser - resultComputer;
